...
public class MySelf extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public MySelf(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int btnWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.MySelf_btnWidth, LayoutParams.MATCH_PARENT);
        int tvWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.MySelf_tvWidth, 80);
